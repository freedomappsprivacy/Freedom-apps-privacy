...
The most complete list of Free and Open Source Software (FOSS) and privacy-respecting alternatives to mainstream software — combining and expanding on the biggest lists in this space.
...
| [APKMirror](https://www.apkmirror.com) | ❌ | ⭐⭐ | Verified APK mirror, no store client, browser-only |
| [Huawei AppGallery](https://appgallery.huawei.com) | ❌ | ⭐⭐ | Alternative ecosystem, relevant mainly for Huawei devices |
| [Amazon Appstore](https://www.amazon.com/appstore) | ❌ | ⭐⭐ | Pre-installed on Fire devices, also available as sideload elsewhere |
...
| App | FOSS | Privacy | Note |
|---|---|---|---|
| [Aegis Authenticator](https://getaegis.app) | ✅ | ⭐⭐⭐⭐⭐ | Encrypted vault, backup/import support |
| [FreeOTP](https://freeotp.github.io) | ✅ | ⭐⭐⭐⭐⭐ | Simple, Red Hat-backed |
| [andOTP](https://github.com/andOTP/andOTP) | ✅ | ⭐⭐⭐⭐ | Archived but still usable, encrypted backups |
| [Tofu Authenticator](https://github.com/pluja/tofu) | ✅ | ⭐⭐⭐⭐⭐ | Clean, minimal, iOS |
| [Ente Auth](https://ente.io/auth) | ✅ | ⭐⭐⭐⭐⭐ | E2EE cloud sync across devices |
| [Raivo OTP](https://github.com/raivo-otp/ios-application) | ✅ | ⭐⭐⭐⭐⭐ | iOS, iCloud E2EE backup |
| [KeePassXC (TOTP field)](https://keepassxc.org) | ✅ | ⭐⭐⭐⭐⭐ | Combine password manager + TOTP in one vault |
| [Authenticator Pro](https://github.com/jamie-mh/AuthenticatorPro) | ✅ | ⭐⭐⭐⭐ | Android, Authy-style categories |
| [2FAS](https://2fas.com) | ✅ | ⭐⭐⭐⭐ | Cross-platform, encrypted cloud backup |
...
| [Waterfox](https://www.waterfox.net) | ✅ | ⭐⭐⭐ | Firefox fork, telemetry-free, older extension support |
| [Pale Moon](https://www.palemoon.org) | ✅ | ⭐⭐⭐ | Independent Goanna-engine fork, very lightweight |
| [GNOME Web (Epiphany)](https://apps.gnome.org/Epiphany/) | ✅ | ⭐⭐⭐ | WebKit-based, minimal, GNOME default |
| [Falkon](https://www.falkon.org) | ✅ | ⭐⭐⭐ | QtWebEngine-based, KDE default |

### Mobile
| App | FOSS | Privacy | Note |
|---|---|---|---|
| [Vanadium](https://github.com/GrapheneOS/Vanadium) | ✅ | ⭐⭐⭐⭐⭐ | Default hardened browser on GrapheneOS |
| [Brave (mobile)](https://brave.com/mobile/) | ✅ | ⭐⭐⭐⭐ | Built-in ad/tracker blocking, Android & iOS |
...
| [Mull](https://gitlab.com/divested-mobile/mull-fenix) | ✅ | ⭐⭐⭐⭐⭐ | LibreWolf-equivalent for Android, via F-Droid |
...
| App | FOSS | Privacy | Note |
|---|---|---|---|
| [Nextcloud](https://nextcloud.com) | ✅ | ⭐⭐⭐⭐⭐ | Full suite: files, calendar, contacts, office, self-hosted |
| [Seafile](https://www.seafile.com) | ✅ | ⭐⭐⭐⭐ | Fast sync, good for large files |
| [Syncthing](https://syncthing.net) | ✅ | ⭐⭐⭐⭐⭐ | Peer-to-peer sync, no central server |
| [CryptPad](https://cryptpad.org) | ✅ | ⭐⭐⭐⭐⭐ | Zero-knowledge encrypted collaboration |
| [ownCloud](https://owncloud.com) | ✅ | ⭐⭐⭐⭐ | Nextcloud's predecessor/parallel project |
| [Proton Drive](https://proton.me/drive) | ⚠️ | ⭐⭐⭐⭐⭐ | E2EE, Swiss-based, clients FOSS |
| [Filen](https://filen.io) | ⚠️ | ⭐⭐⭐⭐ | E2EE consumer cloud storage |
| [pCloud](https://www.pcloud.com) | ❌ | ⭐⭐⭐ | Optional client-side encryption add-on |
| [Tresorit](https://tresorit.com) | ❌ | ⭐⭐⭐⭐ | Business-focused, E2EE |
| [MEGA](https://mega.nz) | ⚠️ | ⭐⭐⭐⭐ | Client-side zero-knowledge encryption, generous free tier, clients partially open |
| [Internxt](https://internxt.com) | ⚠️ | ⭐⭐⭐⭐ | Zero-knowledge encryption, EU-based |
...
| [AdGuard Home](https://adguard.com/en/adguard-home/overview.html) | ✅ | ⭐⭐⭐⭐⭐ | Pi-hole alternative, easier setup |
| [NextDNS](https://nextdns.io) | ❌ | ⭐⭐⭐⭐ | Cloud DNS filtering, cross-device, no-log policy |
| [Blokada](https://blokada.org) | ✅ | ⭐⭐⭐⭐ | Mobile DNS/ad blocking, no root needed |
| [uBlock Origin](https://ublockorigin.com) | ✅ | ⭐⭐⭐⭐⭐ | Browser extension, not DNS-based but essential mention |
| [ControlD](https://controld.com) | ❌ | ⭐⭐⭐⭐ | Customizable filtering DNS service |
...
| App | FOSS | Privacy | Note |
|---|---|---|---|
| [Tutanota (Tuta)](https://tuta.com) | ✅ | ⭐⭐⭐⭐⭐ | E2EE, German-based |
| [Proton Mail](https://proton.me/mail) | ⚠️ | ⭐⭐⭐⭐⭐ | FOSS clients, Swiss-based |
| [AtomicMail](https://atomicmail.io) | ❌ | ⭐⭐⭐⭐ | No phone verification, Web3/crypto-wallet linked identity |
| [Mailbox.org](https://mailbox.org) | ❌ | ⭐⭐⭐⭐ | German, PGP support |
| [Disroot Email](https://disroot.org) | ✅ | ⭐⭐⭐⭐ | Non-profit collective, no logs |
| [Posteo](https://posteo.de) | ❌ | ⭐⭐⭐⭐ | German, anonymous payment options |
| [Runbox](https://runbox.com) | ❌ | ⭐⭐⭐ | Norway-based, no ads |
| [Skiff Mail](https://skiff.com) | ⚠️ | ⭐⭐⭐ | ⚠️ Acquired by Notion in 2024 — service being discontinued, do not recommend for new signups |
| [Mailcow](https://mailcow.email) | ✅ | ⭐⭐⭐⭐⭐ | Self-hosted full mail server stack |
| [Mail-in-a-Box](https://mailinabox.email) | ✅ | ⭐⭐⭐⭐⭐ | Simplified self-hosted mail server |
| [StartMail](https://www.startmail.com) | ❌ | ⭐⭐⭐⭐ | Dutch-based, from Startpage team |

---

## Fediverse Platforms

The Fediverse is a network of interconnected, independently-run servers (via ActivityPub protocol) — an alternative to centralized social media. All entries below are FOSS.

| Platform | Replaces | Note |
|---|---|---|
| [Mastodon](https://joinmastodon.org) | Twitter/X | The largest and most well-known Fediverse platform |
...
|---|---|---|
| Gmail | [Tuta](https://tuta.com), [Proton Mail](https://proton.me/mail) | See Email section for full list |
...
| Google Photos | [Ente Photos](https://ente.io), [PhotoPrism](https://www.photoprism.app), [Nextcloud Memories](https://memories.gallery), [Immich](https://immich.app) | Immich is a fast-growing self-hosted option, Google Photos-like UI |
| Google Play Store | See [Android App Stores](#android-app-stores) | — |
| Gboard | [FlorisBoard](https://florisboard.org), [OpenBoard](https://github.com/openboard-team/openboard), [AnySoftKeyboard](https://anysoftkeyboard.github.io), [Simple Keyboard](https://github.com/rkkr/simple-keyboard), [HeliBoard](https://github.com/Helium314/HeliBoard) | HeliBoard is an actively-developed OpenBoard fork with better UX |
| Google Assistant | [Home Assistant Voice / local voice pipelines](https://www.home-assistant.io/voice_control/) | Self-hosted, local processing |
...
| [Navidrome](https://www.navidrome.org) | ✅ | ⭐⭐⭐⭐⭐ | Music streaming server, Spotify-style |
...
| [Nova Video Player](https://github.com/nova-video-player/aos-AVP) | ✅ | ⭐⭐⭐⭐ | Local/network video player (FTP/SMB/NAS), Netflix-style UI, actively maintained, on F-Droid |
| [Immich](https://immich.app) | ✅ | ⭐⭐⭐⭐⭐ | Fast-growing self-hosted photo/video backup, Google Photos-style UI |
...
| App | FOSS | Privacy | Note |
|---|---|---|---|
| [Signal](https://signal.org) | ✅ | ⭐⭐⭐⭐⭐ | Gold standard, E2EE by default, minimal metadata |
| [SimpleX Chat](https://simplex.chat) | ✅ | ⭐⭐⭐⭐⭐ | No phone/username/ID at all — strongest metadata protection of any app |
| [Session](https://getsession.org) | ✅ | ⭐⭐⭐⭐ | No phone number, onion-routing based |
| [Threema](https://threema.ch) | ⚠️ | ⭐⭐⭐⭐ | Anonymous random ID, Swiss-based, paid app |
| [Briar](https://briarproject.org) | ✅ | ⭐⭐⭐⭐⭐ | Works via Tor/WiFi/Bluetooth mesh, no internet required |
| [TeleGuard](https://teleguard.com) | ❌ | ⭐⭐⭐ | By Swisscows, zero personal info needed but closed-source |
| [Wire](https://wire.com) | ✅ | ⭐⭐⭐ | Team/business focused |
| [Element (Matrix)](https://element.io) | ✅ | ⭐⭐⭐⭐ | Self-hostable, federated |
| [Wickr](https://wickr.com) | ❌ | ⭐⭐⭐ | Owned by AWS/Amazon now |
| [Jami](https://jami.net) | ✅ | ⭐⭐⭐⭐⭐ | Fully P2P/distributed, no central server at all |
| [Delta Chat](https://delta.chat) | ✅ | ⭐⭐⭐⭐ | Messaging over standard email infrastructure |
| [Cwtch](https://cwtch.im) | ✅ | ⭐⭐⭐⭐⭐ | Metadata-resistant, built on Tor onion services |
...
| [Ground News](https://ground.news) | ❌ | ⭐⭐⭐ | Not FOSS, but shows political bias/framing comparison across outlets — useful media-literacy tool rather than a privacy tool per se |
...
| App | FOSS | Privacy | Note |
|---|---|---|---|
| [Joplin](https://joplinapp.org) | ✅ | ⭐⭐⭐⭐⭐ | Evernote alternative, E2EE sync |
| [Standard Notes](https://standardnotes.com) | ✅ | ⭐⭐⭐⭐⭐ | Simple, extensible, E2EE |
| [Logseq](https://logseq.com) | ✅ | ⭐⭐⭐⭐⭐ | Privacy-first knowledge management |
| [AFFiNE](https://affine.pro) | ✅ | ⭐⭐⭐⭐ | Notion/Miro-style all-in-one |
| [Notesnook](https://notesnook.com) | ✅ | ⭐⭐⭐⭐⭐ | Evernote alternative, E2EE |
| [Obsidian](https://obsidian.md) | ⚠️ | ⭐⭐⭐⭐ | Free, local-first, but not open source |
| [Trilium Notes](https://github.com/zadam/trilium) | ✅ | ⭐⭐⭐⭐⭐ | Hierarchical, self-hosted, powerful |
| [Anytype](https://anytype.io) | ✅ | ⭐⭐⭐⭐⭐ | Local-first, E2EE, Notion-style |
...
| App | FOSS | Privacy | Note |
|---|---|---|---|
| [LibreOffice](https://www.libreoffice.org) | ✅ | ⭐⭐⭐⭐⭐ | Standard offline suite |
| [OnlyOffice](https://www.onlyoffice.com) | ✅ | ⭐⭐⭐⭐⭐ | Best MS Office file compatibility, self-hostable |
| [Collabora Online](https://www.collaboraoffice.com/collabora-online/) | ✅ | ⭐⭐⭐⭐⭐ | LibreOffice-based, integrates with Nextcloud |
| [Apache OpenOffice](https://www.openoffice.org) | ✅ | ⭐⭐⭐⭐ | LibreOffice's predecessor, less actively developed |
| [WPS Office (open parts)](https://www.wps.com) | ❌ | ⭐⭐ | Popular but closed source, mentioned as widely-used comparison point |
...
| App | FOSS | Privacy | Note |
|---|---|---|---|
| [Bitwarden](https://bitwarden.com) | ✅ | ⭐⭐⭐⭐⭐ | Full-featured, cloud or self-hosted sync |
| [KeePassXC](https://keepassxc.org) | ✅ | ⭐⭐⭐⭐⭐ | Fully offline, local vault |
| [Vaultwarden](https://github.com/dani-garcia/vaultwarden) | ✅ | ⭐⭐⭐⭐⭐ | Lightweight Bitwarden-compatible self-hosted server |
| [Password Safe](https://pwsafe.org) | ✅ | ⭐⭐⭐⭐⭐ | Bruce Schneier-designed, offline |
| [PassBolt](https://www.passbolt.com) | ✅ | ⭐⭐⭐⭐ | Team-oriented, OpenPGP-based |
| [Proton Pass](https://proton.me/pass) | ⚠️ | ⭐⭐⭐⭐⭐ | E2EE, part of Proton suite |
| [KeePass (original)](https://keepass.info) | ✅ | ⭐⭐⭐⭐⭐ | Windows-native original, many ports exist |
...
| App | FOSS | Privacy | Note |
|---|---|---|---|
| [SearXNG](https://searxng.org) | ✅ | ⭐⭐⭐⭐⭐ | Metasearch engine, combines results from multiple sources |
| [YaCy](https://yacy.net) | ✅ | ⭐⭐⭐⭐⭐ | Peer-to-peer search engine with its own crawler — build your own index |
| [Mojeek](https://www.mojeek.com) | ❌ | ⭐⭐⭐⭐ | Independent crawler, one of few with its own index |
| [Brave Search](https://search.brave.com) | ❌ | ⭐⭐⭐⭐ | Independent index, no tracking |
| [DuckDuckGo](https://duckduckgo.com) | ❌ | ⭐⭐⭐ | Privacy-oriented, uses Bing data under the hood |
| [Startpage](https://www.startpage.com) | ❌ | ⭐⭐⭐ | Anonymized Google results proxy |
| [Ecosia](https://www.ecosia.org) | ❌ | ⭐⭐⭐ | Tree-planting initiative, uses Bing data |
| [Yandex](https://yandex.com) | ❌ | ⭐ | Least censored of the major search engines, Russian-based, not private |
| [Presearch](https://presearch.com) | ⚠️ | ⭐⭐⭐ | Decentralized/crypto-incentivized search |
...
| [FreeTube](https://freetubeapp.io) | ✅ | Private desktop YouTube client |
...
| [Infinity for Reddit](https://github.com/Docile-Alligator/Infinity-For-Reddit) | ✅ | Third-party client, strong anonymous mode (local voting/saving, no account needed), still actively maintained |
...
| [Fosskers/Biglybt](https://www.biglybt.com) | ✅ | ⭐⭐⭐⭐ | Vuze fork, feature-rich |
...
| App | FOSS | Privacy | Note |
|---|---|---|---|
| [Mullvad](https://mullvad.net) | ⚠️ | ⭐⭐⭐⭐⭐ | FOSS clients, no account info required, cash payments accepted |
| [ProtonVPN](https://protonvpn.com) | ⚠️ | ⭐⭐⭐⭐⭐ | FOSS clients, Swiss-based |
| [IVPN](https://www.ivpn.net) | ⚠️ | ⭐⭐⭐⭐⭐ | FOSS clients, strong privacy stance |
| [WireGuard](https://www.wireguard.com) | ✅ | ⭐⭐⭐⭐⭐ | Underlying modern VPN protocol used by most above |
| [PIA (Private Internet Access)](https://www.privateinternetaccess.com) | ⚠️ | ⭐⭐⭐⭐ | FOSS clients, long-standing, audited no-logs |
| [OVPN](https://www.ovpn.com) | ⚠️ | ⭐⭐⭐⭐⭐ | Swedish, diskless servers |
| [AirVPN](https://airvpn.org) | ⚠️ | ⭐⭐⭐⭐ | Run by activists, transparent |
| [Tailscale](https://tailscale.com) | ⚠️ | ⭐⭐⭐⭐ | WireGuard-based mesh VPN, easy self-hosted alternative via Headscale |
| [Headscale](https://headscale.net) | ✅ | ⭐⭐⭐⭐⭐ | FOSS self-hosted Tailscale control server |
